...
public class XmlSchemaValidator {
	...
	public static Schema getSchema(URI aSchemaUri) throws SAXException, MalformedURLException {
	...
	public static XMLSchemaValidatorErrorHandler validate(Reader reader, Schema schema) throws SAXException {
