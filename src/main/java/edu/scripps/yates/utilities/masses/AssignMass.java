...
public class AssignMass {
	...
	public static int getBinnedValue(double mass, double shift) {
		...
		// getBinWidth() + " " +
		// (int)((mass+shift)/getBinWidth() + 0.5) + " " +
		// ((mass+shift)/getBinWidth() + 0.5) + " " +
		// (int)(mass+shift+ 0.5));
		// System.out.println( (int)((mass+shift)/getBinWidth() +
