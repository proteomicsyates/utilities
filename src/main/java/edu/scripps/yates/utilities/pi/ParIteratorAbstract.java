 ...
 * ParIterator interface
 * 
 * It is only intended for internal use, if provides functionality that implies
 * internal knowledge of StaticParIterator, DynamicParIterator,
 * GuidedParIterator, etc.
 * 
...
public abstract class ParIteratorAbstract<E> implements ParIterator<E> {
	...
	// -- elements that have been re-claimed (i.e. after a thread calls
	// localBreak)
