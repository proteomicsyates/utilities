...
public class ParIteratorFactory<E> {
	 ...
	 * @return An instance of <code>ParIterator</code>.
	 */
	public static <E> ParIterator<E> createParIterator(Iterator<E> iterator, int collectionSize, int threadCount,
			ParIterator.Schedule schedulePol, int chunksize) {
		return getIterator(iterator, collectionSize, schedulePol, chunksize, threadCount, false);
	}
	 ...
	 */
	public static <E> ParIterator<E> createParIterator(Iterator<E> iterator, int collectionSize, int threadCount) {
		return getIterator(iterator, collectionSize, ParIterator.Schedule.DYNAMIC, ParIterator.DEFAULT_CHUNKSIZE,
				threadCount, false);
	}
	...
	public static <E> ParIterator<E> createParIterator(Iterator<E> iterator, int collectionSize, int threadCount,
			ParIterator.Schedule schedulePol) {
		return getIterator(iterator, collectionSize, schedulePol, ParIterator.DEFAULT_CHUNKSIZE, threadCount, false);
	}
	 ...
	 * @return An instance of <code>ParIterator</code>.
	 */
	public static <E> ParIterator<E> createParIterator(E[] collection, int threadCount,
			ParIterator.Schedule schedulePol, int chunksize, boolean ignoreBarrier) {
	 ...
	 * @return An instance of <code>ParIterator</code>.
	 */
	public static ParIterator<Integer> createParIterator(int start, int size, int increment, int threadCount,
			ParIterator.Schedule schedulePol, int chunksize, boolean ignoreBarrier) {
	 ...
	 * @return An instance of <code>ParIterator</code>.
	 */
	public static <V> ParIterator getParDFSWorkStealingIterator(GraphAdapterInterface tree, V root, int numOfThreads) {
	 ...
	 * @return An instance of <code>ParIterator</code>.
	 */
	public static <V> ParIterator getTreeParIteratorDFSonDAGTopBottom(GraphAdapterInterface tree, V root,
			int numOfThreads) {
	 ...
	 * @return An instance of <code>ParIterator</code>.
	 */
	public static <V> ParIterator getTreeParIteratorDFSonDAGBottomTop(GraphAdapterInterface graph, V root,
			int numOfThreads) {
	 ...
	 * Dynamic
	 */
	private static <E> ParIterator<E> getIterator(Collection<E> collection, ParIterator.Schedule schedulePol,
		...
		case GUIDED:
			if (collection instanceof RandomAccess) {
				return new GuidedParIteratorRandomAccess<E>((java.util.List<E>) collection, chunksize, threadCount,
						ignoreBarrier);
			} else {
		...
		case DYNAMIC:
			if (collection instanceof RandomAccess) {
				return new DynamicParIteratorRandomAccess<E>((java.util.List<E>) collection, chunksize, threadCount,
						ignoreBarrier);
			} else {
	...
	private static <E> ParIterator<E> getIterator(Iterator<E> iterator, int collectionSize,
			ParIterator.Schedule schedulePol, int chunksize, int threadCount, boolean ignoreBarrier) {
		switch (schedulePol) {
		case STATIC:

			throw new IllegalArgumentException("STATIC schedule is not available for iterators");

		case GUIDED:

			return new GuidedParIteratorSequential<E>(iterator, collectionSize, chunksize, threadCount, ignoreBarrier);

		case DYNAMIC:

			return new DynamicParIteratorSequential<E>(iterator, collectionSize, chunksize, threadCount, ignoreBarrier);
	...
	private static <V> ParIterator getParDFSWorkStealing(GraphAdapterInterface tree, V root, int numOfThreads) {
		return new DFSWorkStealing(tree, root, numOfThreads);
	}

	public static <V> ParIterator getTreeIteratorDFSonDAGBottomTop(GraphAdapterInterface tree, V root,
			int numOfThreads) {
